...
function start(){
    ...
    setTimeout(function(){  $sixth.velocity({opacity:1}, 2000, [700, 40],function(){});},520);
...
function end() {
  ...
  setTimeout(function(){$fourth.velocity({scale:"3", translateY:"0%"},1100, [500, 40], function(){
    $(".b-landing").velocity({opacity:'1'},200);


  });},1800);
  setTimeout(function(){$svg.velocity({opacity:'0'});},1800);
